...
signAcademicHonestyPolicy('Pranav Mehendiratta', '9074036501');
...
threshold_list = [graythresh(imread([img_list{1} '.png'])), graythresh(imread([img_list{2} '.png'])), graythresh(imread([img_list{3} '.png']))];
